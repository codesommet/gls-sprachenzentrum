...
@section('breadcrumb-item-active', 'Nouvelle Application')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('backoffice.applications.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf

            <div id="app-form-card" class="card animate__animated animate__rollIn">
                <div class="card-header">
                    <h5>Créer une Application</h5>
                </div>
