...
@section('title', 'Historique imports impayés')
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-sm-flex justify-content-between align-items-center">
                <h5 class="mb-0">Historique imports impayés</h5>
                <a href="{{ route('backoffice.encaissements.impayes.imports.create') }}" class="btn btn-primary btn-sm">
                ...
                <table class="table table-hover table-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="text-end">Total impayés</th>
                    ...
                    <tbody>
                        @forelse($imports as $import)
                            <tr>
                                ...
                                <td class="text-end fw-bold text-danger">{{ number_format($import->total_amount, 2, ',', ' ') }} DH</td>
                                ...
                                <td class="text-end text-nowrap">
                                    <a href="{{ route('backoffice.encaissements.impayes.imports.show', $import) }}" class="avtar avtar-xs btn-link-primary" title="Voir"><i class="ph-duotone ph-eye"></i></a>
                                    <form action="{{ route('backoffice.encaissements.impayes.imports.destroy', $import) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer?')">
                                        @csrf @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="9" class="text-center text-muted py-4">Aucun import d'impayés trouvé.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
