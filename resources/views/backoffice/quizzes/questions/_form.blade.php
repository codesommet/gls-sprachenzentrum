...
<div class="row g-3">
    ...
    <div class="col-12">
        ...
        <div class="row g-3">
            ...
            {{-- Audio upload --}}
            <div class="col-md-6">
                <label class="form-label">Audio (optionnel)</label>
                ...
                @if ($audioUrl)
                    <div class="mt-2">
                        ...
                        <div class="text-muted small mt-1">Audio actuel</div>
                    </div>
                @endif
            </div>
            ...
            <div class="col-12">
                ...
                <input type="text" name="media_caption"
                    ...
                    placeholder="Exemple: Écoutez et choisissez la bonne réponse">
                @error('media_caption')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
    ...
    <div class="col-md-3 d-flex align-items-end">
        <div class="form-check">
            ...
            <label class="form-check-label" for="q_is_active">Actif</label>
        </div>
    </div>
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="correct_index"
                                value="{{ $i }}" @checked((int) $correctIndex === (int) $i)>
                        </div>
