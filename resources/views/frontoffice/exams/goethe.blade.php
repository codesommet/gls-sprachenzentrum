...
@section('content')
        ...
        <div class="container gls-more-info-container reveal delay-2">
            ...
            <div class="gls-more-info-grid">
                ...
                <div class="gls-info-card reveal delay-1">
                    ...
                    <a href="/courses" class="gls-info-button w-button">{{ __('goethe.path.card1.button') }}</a>
                </div>
                ...
                <div class="gls-info-card reveal delay-2">
                    ...
                    <div class="gls-info-spacer"></div>
                    <a href="/exams/goethe" class="gls-info-button w-button">{{ __('goethe.path.card2.button') }}</a>
                </div>
                ...
                <div class="gls-info-card reveal delay-3">
                    ...
                    <div class="gls-info-spacer"></div>
                    <a href="/exams/goethe#dates" class="gls-info-button w-button">{{ __('goethe.path.card3.button') }}</a>
                </div>
                ...
                <div class="gls-info-card reveal delay-1">
                    ...
                    <div class="gls-info-spacer"></div>
                    <a href="/exams/goethe" class="gls-info-button w-button">{{ __('goethe.path.card4.button') }}</a>
                </div>
    ...
    <div class="courses-section section reveal delay-1">
        <div class="container is-h-courses reveal delay-2">
            ...
            <div class="subtitle reveal delay-2">{{ __('goethe.exams.subtitle') }}</div>
            ...
            <div class="exam-cards">
                ...
                <div class="exam-card reveal delay-1">
                    ...
                    <a href="/exams/goethe" class="button is-course-card w-button">{{ __('goethe.exams.card1.button') }}</a>
                </div>
                ...
                <div class="exam-card is-orange reveal delay-2">
                    ...
                    <a href="#" class="button is-course-card w-button">{{ __('goethe.exams.card2.button') }}</a>
                </div>
                ...
                <div class="exam-card is-yellow reveal delay-3">
                    ...
                    <a href="/placement-test" class="button is-course-card w-button">{{ __('goethe.exams.card3.button') }}</a>
                </div>
    ...
    {!! __('goethe.contact.title') !!}
            ...
            <div class="footer-socials-block reveal delay-1">
                ...
                <div class="div-block-20 reveal delay-1">
                    <a href="#" class="footer-social-link ig reveal delay-2">
                        <i class="bi bi-instagram"></i>
                    </a>
                    <a href="#" class="footer-social-link fb reveal delay-3">
                        <i class="bi bi-facebook"></i>
                    </a>
                    <a href="#" class="footer-social-link yt reveal delay-1">
                        <i class="bi bi-youtube"></i>
                    </a>
                    <a href="#" class="footer-social-link wa reveal delay-2">
        ...
        <a href="https://maps.app.goo.gl/g4PjrPB7wHQAqrSZA" target="_blank" class="div-block-7 reveal delay-3">
            <iframe src="{{ __('goethe.contact.map_url') }}"
                    loading="lazy"
                    allowfullscreen
